...
export const RegisterComp = () => {
  ...
  const submitForm = async (e) => {
    e.preventDefault();
    setError('');  //Clear  Mismatched Errors
  ...
  }; //register or add it to the user
  // console.log('email is ' ${emailRef.current.value} );
  
  // console.log('email is ' ${passwordRef.current.value} );
  
  // console.log('email is ' ${cmfPasswordRef.current.value} );
